...
class Feed():
    """
    A Feed is the fundamental unit of an Active Feed. It provides the ultimate basis for centralized memory
    ...
    mananger : FeedManager(), optional **DO NOT MODIFY**
    ...
    def __init__(self, identifier, start_date = None, end_date = None, feed = None, manager = FeedManager(), cache = None):
...
class FeedGroup():
    """
    A FeedGroup provides a way to group together various feeds.
